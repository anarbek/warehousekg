        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClockInUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_attendance_records_shifts_ShiftId",
                        column: x => x.ShiftId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_employee_warehouse_assignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_employee_warehouse_assignments_employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_employee_warehouse_assignments_warehouses_WarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_employee_shift_assignments_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_employee_shift_assignments_TenantId_EmployeeId_EffectiveFro~",
                table: "employee_shift_assignments",
                columns: new[] { "TenantId", "EmployeeId", "EffectiveFromUtc" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_employee_warehouse_assignments_EmployeeId",
                table: "employee_warehouse_assignments",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_employee_warehouse_assignments_TenantId_EmployeeId_Warehous~",
                table: "employee_warehouse_assignments",
                columns: new[] { "TenantId", "EmployeeId", "WarehouseId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_employee_warehouse_assignments_WarehouseId",
                table: "employee_warehouse_assignments",
                column: "WarehouseId");
