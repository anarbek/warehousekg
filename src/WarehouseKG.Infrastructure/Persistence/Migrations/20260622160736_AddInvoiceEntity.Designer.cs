...
namespace WarehouseKG.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260622160736_AddInvoiceEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WarehouseKG.Domain.Entities.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ReportLayoutId")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("WarehouseKG.Domain.Entities.InvoiceLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WarehouseKG.Domain.Entities.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WarehouseKG.Domain.Entities.InvoiceLine", b =>
                {
                    ...
                    b.HasOne("WarehouseKG.Domain.Entities.Invoice", "Invoice")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("WarehouseKG.Domain.Entities.ItemCategory", b =>
                {
                    b.HasOne("WarehouseKG.Domain.Entities.ItemCategory", "Parent")
                        .WithMany("Children")
