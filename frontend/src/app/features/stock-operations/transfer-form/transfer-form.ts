...
export class TransferForm implements OnInit {
  ...
  protected formData:any={number:'',sourceWarehouseId:'',destinationWarehouseId:'',notes:'',transferredAtUtc:new Date()};
