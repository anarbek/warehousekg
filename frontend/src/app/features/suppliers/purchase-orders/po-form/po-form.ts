...
@Component({selector:'app-po-form',imports:[ReactiveFormsModule,DxFormModule,DxSelectBoxModule,DxTextBoxModule,DxButtonModule,DxProgressBarModule],templateUrl:'./po-form.html',styleUrl:'./po-form.scss'})
export class PoForm implements OnInit {
  ...
  protected formData:any={number:'',supplierId:'',warehouseId:'',currency:'KGS',expectedDateUtc:'',notes:''};
